function joystick1(Obstacle, joy)
    ...
    if double(buttons(1)) == 1
        Obstacle.ObstaclePose(3,4) = Obstacle.ObstaclePose(3,4)-0.1;
        down = Obstacle.ObstaclePose;
        Obstacle.move(down);
        drawnow();
    elseif double(buttons(2)) == 1
        Obstacle.ObstaclePose(2,4) = Obstacle.ObstaclePose(2,4)-0.1;
    ...
    elseif double(buttons(5)) == 1
        Obstacle.ObstaclePose(1,4) = Obstacle.ObstaclePose(1,4)-0.1;
