...
%% Create the robot model
        function CreateModel(self)       
            ...
            L1 = Link('d',0.45,    'a',0,      'alpha',-pi/2,  'offset',0, 'qlim',[deg2rad(-360),deg2rad(360)]);
            L2 = Link('d',0,        'a',0.53,  'alpha',0,      'offset',-1.75, 'qlim',[deg2rad(-118),deg2rad(120)]);
            L3 = Link('d',0,        'a',0.4,  'alpha',0,      'offset',3, 'qlim',[deg2rad(-11),deg2rad(225)]);
            L4 = Link('d',0,        'a',0.2,      'alpha',-pi/2,  'offset', -1.3482664, 'qlim',[deg2rad(-97),deg2rad(180)]);
